...
namespace IVIMYSQL.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        // GET api/Account/GetSecurityQuestion/useremail
        [HttpGet]
        [AllowAnonymous]
            ...
            if (model.SecurityAnswer != null && model.SecurityAnswer != "")
            {
                ...
                if (response.isSuccess)
                {
                    ...
                    else
                    {
                        ...
                        response.ErrorList = new List<string> { "Email Is Blank or Incorrect. Please Enter Correct Email." };
                        return GetErrorResult(response);
                    }
                }
                else
                {
                    response.ErrorList = new List<string> { "Answer for Security Question is Incorrect. Please Enter Correct Security Question Answer." };
                    return GetErrorResult(response);
                }
            }
            else
